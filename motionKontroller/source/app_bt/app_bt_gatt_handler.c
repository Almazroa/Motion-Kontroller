...
void app_bt_send_message(void)
{
    ...
    {
        printf("Client not registered for notification or indication\n");
        return;
    }
...
void app_bt_gatt_set_notify_value(Peripheral peripheral)
{
    app_hello_sensor_notify[0] = peripheral;
}
